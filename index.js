      ...
      .then((data) => {
        connection.query(
          "SELECT * FROM employee " +
            ...
            "WHERE roles.department_id = (SELECT id FROM department WHERE name = ?)",
          [data.depChoice],
          function (err, res) {
            if (err) throw err;
            console.table(res);
      ...
      inquirer
        ...
        .then((data) => {
          connection.query(
            ...
            [roleChoices.indexOf(data.role) + 1, data.empChoice],
            function (err, res) {
              if (err) throw err;
...
const addTotalByDep = () => {
  connection.query("SELECT * FROM department", function (err, res, fields) {
    ...
    inquirer
      ...
      .then((data) => {
        connection.query(
          "SELECT SUM(salary) FROM roles WHERE department_id = (SELECT id FROM department WHERE name = ?)",
          data.depChoice,
          function (err, res) {
            if (err) throw err;
            console.table(res);
